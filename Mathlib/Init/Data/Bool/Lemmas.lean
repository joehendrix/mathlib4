...
#align bool.cond_tt cond_true

#align bool.cond_ff cond_false
...
theorem and_eq_false_eq_eq_false_or_eq_false (a b : Bool) :
    ((a && b) = false) = (a = false ∨ b = false) := propext (Bool.and_eq_false_iff a b)
...
theorem or_eq_false_eq_eq_false_and_eq_false (a b : Bool) :
    ((a || b) = false) = (a = false ∧ b = false) :=  propext (Bool.or_eq_false_iff a b)
